...
def main():
    ...
    # Required parameters
    parser.add_argument("--method", default='pet', choices=['pet', 'ipet', 'sequence_classifier'],  # required=True,
                        help="The training method to use. Either regular sequence classification, PET or iPET.")
    parser.add_argument("--data_dir", default='input_data/', type=str,  # required=True,
                        help="The input data dir. Should contain the data files for the task.")
    parser.add_argument("--model_type", default='roberta', type=str, choices=MODEL_CLASSES.keys(),  # required=True,
                        help="The type of the pretrained language model to use")
    parser.add_argument("--model_name_or_path", default='roberta-base',  # required=True,
                        type=str,
                        help="Path to the pre-trained model or shortcut name")
    parser.add_argument("--task_name", default='yelp-full', type=str, choices=PROCESSORS.keys(),  # required=True,
                        help="The name of the task to train/evaluate on")
    parser.add_argument("--output_dir", default='outputs_roberta_1/', type=str,  # required=True,
    ...
    parser.add_argument("--pet_max_seq_length", default=128, type=int, #256
                        help="The maximum total input sequence length after tokenization for PET. Sequences longer "
                             "than this will be truncated, sequences shorter will be padded.")
    parser.add_argument("--pet_per_gpu_train_batch_size", default=2, type=int, #4
                        help="Batch size per GPU/CPU for PET training.")
    parser.add_argument("--pet_per_gpu_eval_batch_size", default=4, type=int, #8
                        help="Batch size per GPU/CPU for PET evaluation.")
    parser.add_argument("--pet_per_gpu_unlabeled_batch_size", default=2, type=int, #4
